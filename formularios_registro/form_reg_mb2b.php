														...
														<div class="row">
															<div class="col-xs-12">
																...
																<div class="form-horizontal" role="form">
																	<input type="hidden" value="4" id="evento_id">
																	...
																	<div class="form-group">
																		<div class="col-xs-12 col-sm-6">
																			...
																			<div class="col-xs-12 col-sm-12">
																				...
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_1" value="Hoteles" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Hoteles</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_2" value="Restaurantes" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Restaurantes</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_3" value="Desarrollos Inmobiliarios" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Desarrollos Inmobiliarios</span><br>
																				...
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_5" value="Estadios" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Estadios</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_6" value="Parques Industriales" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Parques Industriales</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_7" value="Fábricas" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Fábricas</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_dat_emp_giro_8" value="Hospitales" name="orderBoxGiros[]" onchange="pasarcheckgiros()">
																				<span class="lbl">Hospitales</span><br>
																	...
																	<div class="form-group">
																		<div class="col-xs-12 col-sm-12">
																			...
																			<div class="col-xs-12 col-sm-12">
																				...
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_1" value="Sistema Eléctrico / Iluminación" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Sistema Eléctrico / Iluminación</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_2" value="Sistemas Hidrosanitarios" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Sistemas Hidrosanitarios </span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_3" value="Aires Acondicionados" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Aires Acondicionados</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_4" value="Maquinaria y Equipos" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Maquinaria y Equipos (calderas, plantas de emergencia generadores de luz, etc.)</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_5" value="Limpieza" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Limpieza</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_6" value="Seguridad e Incendios" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Seguridad e Incendios</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_7" value="Fumigación / Jardinería" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Fumigación / Jardinería </span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_8" value="Elevadores / Escaleras Eléctricas / Accesos" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Elevadores / Escaleras Eléctricas / Accesos</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_9" value="Telecomunicaciones" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Telecomunicaciones</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_10" value="Pintura / Impermeabilización" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Pintura / Impermeabilización</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_11" value="Estacionamientos" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Estacionamientos</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_12" value="Empresas especializadas en admon de mantenimiento" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Empresas especializadas en admon de mantenimiento</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_13" value="Instalaciones Deportivas" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Instalaciones Deportivas</span><br>
																				<input  type="checkbox" class="ace" id="reg_compr_lineas_ints_14" value="Otros" name="orderBoxLineasProd[]" onchange="pasarchelineasprod()">
																				<span class="lbl">Otros</span>
																			</div>
																		</div>
																	</div>
